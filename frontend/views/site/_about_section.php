    ...
    <div class="col-lg-3 col-md-6 mb-4">
        <div class="card info bg-white shadow-lg p-1 p-xl-4">
            <?php if ($model[$item]['icon'] === 1): ?>
                ...
                <h5 class="mt-0"><?= $model[$item]['title_'.$language] ?></h5>
                <p><?= $model[$item]['description_'.$language] ?></p>
            <?php elseif ($model[$item]['icon'] === 2): ?>
                <div class="icon icon-shape mx-auto">
            ...
            <?php else: ?>
                <div class="icon icon-shape mx-auto">
                    <svg class="text-warning" width="25px" height="25px" viewBox="0 0 43 36" version="1.1"
                         xmlns="http://www.w3.org/2000/svg">
